        ...
        for (row = 0; row < 5; row = row + 1) begin : row_loop
            for (col = 0; col < 10; col = col + 1) begin : col_loop
                display_shape brick_inst (
                    ...
                    .redVal(row == 0 ? 3'b111 : row == 1 ? 3'b000 : row == 2 ? 3'b100 : row == 3 ? 3'b111 : 3'b111),
                    .greenVal(row == 0 ? 3'b011 : row == 1 ? 3'b111 : row == 2 ? 3'b100 : row == 3 ? 3'b000 : 3'b110),
                    .blueVal(row == 0 ? 2'b11 : row == 1 ? 2'b00 : row == 2 ? 2'b11 : row == 3 ? 2'b01 : 2'b01),
